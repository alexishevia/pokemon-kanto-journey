// Gen 1 Pokemon data with spritesheet coordinates
// Spritesheet: 16 columns, 64x64px per sprite
...
// Evolution families: maps every Pokemon ID to its family ID (base form's ID)
// Eevee family uses Eevee (133) as the shared family ID
const EVOLUTION_FAMILY = {};
...
(function buildFamilies() {
  ...
  chains.forEach((chain) => {
    ...
    FAMILY_MEMBERS[familyId] = chain;
    chain.forEach((id) => {
      EVOLUTION_FAMILY[id] = familyId;
    });
  });
})();

function getFamilyMembers(pokemonId) {
  const familyId = EVOLUTION_FAMILY[pokemonId];
  return FAMILY_MEMBERS[familyId] || [pokemonId];
}

function getSpriteCoords(pokemonId) {
